...
class manager(school):
    def __init__(self,branch,teacher,department,avaliable,title):
        super().__init__(branch,teacher,department,avaliable)
        self.title=title
    ...
    def show_info(self):
        ...
        print("Branch: {}\nTeacher: {}\nDepartment: {}\nAvaliable Student: {}\n Title: {}".format(self.branch,self.teacher,self.department,self.avaliable,self.title))
